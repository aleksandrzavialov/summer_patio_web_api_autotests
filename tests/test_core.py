...
class TestsMainScreen:
    ...
    def test_authorize(self, browser_management):
        ...
        with allure.step('Check that menu appears'):
            ...
            # browser.
            headers = browser.driver.execute_script("var req = new XMLHttpRequest();req.open('GET', document.location, false);req.send(null);return req.getAllResponseHeaders()")
            # time.sleep(15)
            driver = webdriver.Chrome
            print('ALL REQUESTS:' + str(driver.requests))
            print('1')
